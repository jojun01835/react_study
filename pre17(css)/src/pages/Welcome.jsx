...
export default function WelcomePage() {
  ...
  const YText = useTransform(scrollY, [0, 200, 300, 500, 700], [0, 50, 50, 500, 700]);
  return (
    <>
      ...
      <main id="welcome-content">
        <section>
          ...
          <p>
            With our platform, you can set, track, and conquer challenges at your own pace. Whether it&apos;s personal growth, professional achievements, or
        ...
        <section>
          ...
          <p>
            Challenges provide a framework for growth. They push boundaries, test limits, and result in genuine progress. Here, we believe everyone has untapped
